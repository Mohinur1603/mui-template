...
export default function Landing() {
  return (
    ...
    <Grid conteiner>
      <Grid item sx={12} md={6} lg={6}> <div>
        <h2
          class="display-5 fw-bold"
          style={{ color: "#261F31", opacity: "0.9" }}
        >
          Turn your ideas <br></br>into a {""}
          <span class="text-success">success.</span>
        </h2>
        <Typography variant="h6" sx={{ color: "#63527E", my: "20px",opacity:"0.8" }}>
          Webbee will make your product look modern and professional <br></br>while
